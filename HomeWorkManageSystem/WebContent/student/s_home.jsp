...
<%@ page language="java" import="hwms.entity.Notice" %>
<%@ page language="java" import="hwms.entity.Student" %>
<%@ page language="java" import="hwms.entity.Work" %>
<%@ page language="java" import="hwms.service.NoticeManage" %>
<%@ page language="java" import="hwms.service.WorkManage" %>
...
<!-- 包含 bootstrap 样式表 -->
<link rel="stylesheet"
	href="/HomeWorkManageSystem/BootStrap/css/bootstrap.min.css">
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="carousel slide" id="carousel-598343"
					data-ride="carousel"
					style="width: 1200px; height: 200px; background: url(/HomeWorkManageSystem/img/back.jpg); color: white;">
					<ol class="carousel-indicators">
					<c:if test="${!empty notice }">
					<c:forEach items="${session.notice }" var="n" varStatus="loop">
					<c:choose>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									指导教师:&nbsp;<input type="text" name="teacher" value="${w.w_t_Name }" readonly="readonly" style="border:none;"/><br><br>
