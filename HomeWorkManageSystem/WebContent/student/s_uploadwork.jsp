...
<body>
	...
	<div class="container-fluid " style="background-color: blasck;padding: 0px;margin-left: 4%;">
		<div class="row-fluid">
			<div class="span12">
				<form action="/HomeWorkManageSystem/uploadServlet"  method = "post" enctype="multipart/form-data">
...
<%-- <div class="container-fluid " style="background-color: blasck;padding: 0px;margin-left: 4%;">
	<div class="row-fluid">
		<div class="span12">
			<form action="/HomeWorkManageSystem/student/s_uploadwork"  method = "post" enctype="application/form-data">
