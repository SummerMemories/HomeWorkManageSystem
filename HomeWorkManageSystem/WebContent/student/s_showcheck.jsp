...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12" >
            <table class="table table-hover table-bordered table-striped">
				...
				<c:forEach items="${work }" var="w" varStatus="loop">
                    <tr >
                        ...
                        <td>
                            <a id="modal-${checkwork[loop.count-1].ch_Num }" href="#${checkwork[loop.count-1].ch_Num }" data-toggle="modal">查看</a>
                        </td>
                       <c:choose>
            ...
            <div class="modal fade" id="${cw.ch_Num }" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
