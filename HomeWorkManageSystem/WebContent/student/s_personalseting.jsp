					...
					<div class="modal fade" id="modal-container-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="/HomeWorkManageSystem/studentServlet"  method = "post" >
								<div class="modal-body">
									<input type = "hidden" name = "s_num"  value = "${student.s_Num }"/>								<!--修改内容提示  -->
									<input type = "hidden" name = "s_account"  value = "${student.s_Account }"/>
									<input type = "hidden" name = "s_password"  value = "${student.s_Password }"/>
									<input type = "hidden" name = "s_class"  value = "${student.s_Class }"/>
					...
					<div class="modal fade" id="modal-container-4" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="/HomeWorkManageSystem/studentServlet" method = "post" enctype="multipart/form-data">
								<div class="modal-body">
									<input type = "hidden" name = "s_num"  value = "${student.s_Num }"/>								<!--修改内容提示  -->
									<input type = "hidden" name = "s_account"  value = "${student.s_Account }"/>
									...
									原&nbsp;&nbsp;密&nbsp;码:<input type="password" name="oldpaw" value="${ student.s_Password}" readonly disabled> <br><br>
