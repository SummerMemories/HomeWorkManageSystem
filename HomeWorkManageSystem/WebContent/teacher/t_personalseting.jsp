						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<input type="hidden" name="id" value="${teacher.t_Num }"/>		<!--修改内容提示  -->
					...
					<div class="modal fade" id="modal-container-3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form class="cmxform" id="form3" action="/HomeWorkManageSystem/teacherServlet" method = "post">
									<div class="modal-body">
										<p><input type="hidden" name="id" value="${teacher.t_Num }" /></p>		<!--修改内容提示  -->
											<input type = "hidden" name = "funct"  value = "updatePassword"/>
											<!-- <label >原&nbsp;&nbsp;密&nbsp;码:</label> -->
											原&nbsp;&nbsp;密&nbsp;码:<input type="password" name="oldpaw" value="${teacher.t_Password }" readonly="readonly" disabled > <br><br>
