                ...
                <table class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
						...
						%>				
					                            ...
					                            <td style="text-align:center;vertical-align:middle"><%=chW.get(j).getCh_UpTime() %></td>
					                            <%
					                            ...
					                            %>			
					                            			...
					                            			<td style="text-align:center;vertical-align:middle">
					                            				<a type="button" class="download" href = "/HomeWorkManageSystem/downloadServlet?ch_num=<%=chW.get(j).getCh_Num()%>">下载</a>
					                            			</td>
					                            <%	}
					                            		else{
					                            %>			
					                            			<td style="text-align:center;vertical-align:middle"><%=chW.get(j).getCh_CheckTime() %></td><!-- 此时已有时间 -->
					                            			...
					                            			<td style="text-align:center;vertical-align:middle"><a href="/HomeWorkManageSystem/downloadServlet?ch_num=<%=chW.get(j).getCh_Num()%>">下载</a></td>
					                            <%
					                            		}
					                            %>
						<%
