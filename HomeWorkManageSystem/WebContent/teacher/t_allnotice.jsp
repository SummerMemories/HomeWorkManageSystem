        ...
        <div class="span12" style=" ">
                    ...
                    <c:if test="${! empty n }">
                		<c:forEach items="${n }" var="n"> 
		                			<tr >
				                        ...
				                        <td>${n.nt_Time  }</td> 
				                        <td>${n.nt_cour_ID  }</td> 
				                        <td><a id="modal-1" href="#${n.nt_Num}" data-toggle="modal">查看</a></td>
				                        <td>
											<a type="button" class="close" href = "javascript:del('${n.nt_Num }')">
            ...
            <c:if test="${! empty n }">
                <c:forEach items="${n }" var="n">
		            <!--遮罩窗体-->
		            <!--遮罩窗体111-->
		            <div class="modal fade" id="${n.nt_Num}" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
