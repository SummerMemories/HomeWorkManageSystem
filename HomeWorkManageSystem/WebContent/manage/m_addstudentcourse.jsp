		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<form class="form-horizontal" action="/HomeWorkManageSystem/manageServlet" method="post" role="form">
					<input type="hidden" name="funct" value="addSC"  />
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">学生账号:</label>
						<div class="col-sm-2">
							<input type="text" name="sc_s_account" class="form-control" id="inputEmail3">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" name="sc_cour_id" class="form-control" id="inputEmail3"/>
						</div>
					</div>			
