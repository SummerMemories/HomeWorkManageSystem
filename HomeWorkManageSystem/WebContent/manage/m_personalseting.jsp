...
<head>
	...
	<!-- 验证的包 -->
	<script src="/HomeWorkManageSystem/js/jQuery_Validate/jquery-validation-1.14.0/lib/jquery.js"></script>
	<script src="/HomeWorkManageSystem/js/jQuery_Validate/jquery-validation-1.14.0/dist/jquery.validate.min.js"></script>
	<script src="/HomeWorkManageSystem/js/jQuery_Validate/jquery-validation-1.14.0/dist/localization/messages_zh.js"></script>
					...
					<div class="modal fade" id="modal-container-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="/HomeWorkManageSystem/manageServlet" method = "post">
								<div class="modal-body">
									<input type="hidden" name="funct" value="updateAccount" />
									原账号:<input type="text" name="oldaccount" value="${manage.m_Account }" readonly="readonly" disabled > <br><br>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									原名:<input type="text" name="oldname" value="${manage.m_Name }" readonly="readonly" disabled > <br><br>
					...
					<div class="modal fade" id="modal-container-3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form class="cmxform" id="form3" action="/HomeWorkManageSystem/manageServlet" method = "post">
									<div class="modal-body">
											<input type="hidden" name="funct" value="updatePassword" />
											<!-- <label >原&nbsp;&nbsp;密&nbsp;码:</label> -->
											原&nbsp;&nbsp;密&nbsp;码:<input type="password" name="oldpaw" value="${manage.m_Password }" readonly="readonly" disabled > <br><br>
