		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<form class="form-horizontal" action="/HomeWorkManageSystem/manageServlet" method="post" role="form">
					<input type="hidden" name="cour_num" value="${c.cour_Num}"  /><!-- 隐藏域，传递教师id -->
					<input type="hidden" name="funct" value="updateC"  />
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">课程名:</label>
						<div class="col-sm-2">
							<input type="text" name="cour_name" class="form-control" id="inputEmail3" value="${c.cour_Name}"/>
						</div>
					</div>
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">学分:</label>
						<div class="col-sm-2">
							<input type="text" name="cour_credit" class="form-control" id="inputEmail3" value="${c.cour_Credit}" />
						</div>
					</div>
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">课程号:</label>
						<div class="col-sm-2">
							<input type="text" name="cour_id" class="form-control" id="inputEmail3" value="${c.cour_ID}"/>
						</div>
					</div>
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">课程人数:</label>
						<div class="col-sm-2">
							<input type="text" name="cour_count" class="form-control" id="inputEmail3" value="${c.cour_Count}" />
						</div>
					</div>
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">教师工号:</label>
						<div class="col-sm-2">
							<input type="text" name="cour_t_id" class="form-control" id="inputEmail3" value="${c.cour_t_ID}" />
						</div>
					</div>
					<div class="form-group">
